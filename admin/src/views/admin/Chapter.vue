      ...
      <tr v-for="(chapter,index) in chapters" :key="index">
        ...
        <td>
          <div class="hidden-sm hidden-xs btn-group">
            <button class="btn btn-white btn-info btn-bold" @click="toSection(chapter)">
              小节
            </button>&nbsp;&nbsp;
            <button class="btn btn-white btn-info btn-bold" @click="showEdit(chapter)">
              编辑
            </button>&nbsp;&nbsp;
            <button class="btn btn-white btn-danger btn-bold" @click="remove(chapter.id)">
              删除
            </button>
          </div>
